...
function(e,t,n){"use strict";var o=function(e){return e&&e.__esModule?e["default"]:e},r=o(n(/*! ./bootstrap */1)),c=o(n(/*! ../locales/en.json */2));Hull.ready(function(e,t,n,o){var u=n.deployments[0];u.ship.translations.en=c,r(document.querySelector("#ship"),u)})},/*!**************************!*\
  !*** ./src/bootstrap.js ***!
  \**************************/
function(e,t,n){"use strict";function o(e,t){var n=Hull.entity.encode(Hull.findUrl());Hull.api(""+n+"/comments",{wrapped:!0},function(n){var o,r=n.pagination.total||0;o=r>1?"more_comment":1===r?"one_comment":"zero_comment";var c=t.ship.translations.en[o].replace("{count}",r);e.innerHTML=c})}e.exports=o},/*!*************************!*\
  !*** ./locales/en.json ***!
  \*************************/
